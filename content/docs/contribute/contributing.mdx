...
- **IDE Extensions**: Develop an extension for your favorite IDE to add it to the list of supported ones. Refer to the [Extension Spec Sheet](/extension-spec-sheet).
