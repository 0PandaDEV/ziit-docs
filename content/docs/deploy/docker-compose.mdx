...
To get started download the [docker-compose.yml](https://github.com/0PandaDEV/Ziit/blob/main/docker-compose.yml) file from the github repository.
...
<Callout type="warn">
  Be sure to replace the example values with your actual configuration details
  before proceeding.
</Callout>
